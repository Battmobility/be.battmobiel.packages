...
InputNumberBaseDirective.ɵfac = function InputNumberBaseDirective_Factory(t) { return new (t || InputNumberBaseDirective)(); };
InputNumberBaseDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: InputNumberBaseDirective, viewQuery: function InputNumberBaseDirective_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 1);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.inputElement = _t.first);
    } }, inputs: { placeholder: "placeholder", maxFraction: "maxFraction", isDisabled: "isDisabled", labelForId: "labelForId", invalid: "invalid" }, outputs: { changeValue: "changeValue", touch: "touch" } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(InputNumberBaseDirective, [{
        type: Directive
