(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@sofico-framework/ui-kit/components/form'), require('@sofico-framework/ui-kit/directives/focus'), require('ngx-reactivetoolkit'), require('rxjs/operators'), require('@angular/common'), require('@ngx-translate/core'), require('@sofico-framework/ui-kit/components/loading'), require('ng-zorro-antd/select')) :
    typeof define === 'function' && define.amd ? define('@sofico-framework/ui-kit/components/input-single-select', ['exports', '@angular/core', '@angular/forms', '@sofico-framework/ui-kit/components/form', '@sofico-framework/ui-kit/directives/focus', 'ngx-reactivetoolkit', 'rxjs/operators', '@angular/common', '@ngx-translate/core', '@sofico-framework/ui-kit/components/loading', 'ng-zorro-antd/select'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['sofico-framework'] = global['sofico-framework'] || {}, global['sofico-framework']['ui-kit'] = global['sofico-framework']['ui-kit'] || {}, global['sofico-framework']['ui-kit'].components = global['sofico-framework']['ui-kit'].components || {}, global['sofico-framework']['ui-kit'].components['input-single-select'] = {}), global.ng.core, global.ng.forms, global['sofico-framework']['ui-kit'].components.form, global['sofico-framework']['ui-kit'].directives.focus, global.ngxReactivetoolkit, global.rxjs.operators, global.ng.common, global.core$1, global['sofico-framework']['ui-kit'].components.loading, global.select));
}(this, (function (exports, core, forms, form, focus, ngxReactivetoolkit, operators, common, core$1, loading, select) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.InputSingleSelectComponent = InputSingleSelectComponent_1 = /** @class */ (function () {
        function InputSingleSelectComponent(form, ngControl, changeDetectorRef) {
            var _this = this;
            this.form = form;
        ...
        InputSingleSelectComponent.prototype.sofFocus = function () {
            this.inputElement.nativeElement.getElementsByTagName('input')[0].focus();
            this.changeDetectorRef.detectChanges();
        };
        InputSingleSelectComponent.prototype.ngOnInit = function () {
            var _this = this;
        ...
        InputSingleSelectComponent.prototype.ngOnChanges = function () { };
        InputSingleSelectComponent.prototype.ngOnDestroy = function () {
            var _a;
        ...
        InputSingleSelectComponent.prototype.registerOnChange = function (fn) {
            this.propagateChange = fn;
        };
        InputSingleSelectComponent.prototype.registerOnTouched = function (fn) {
            this.propagateTouch = fn;
        };
        InputSingleSelectComponent.prototype.writeValue = function (value) {
            this.internalFormControl.setValue(value !== null && value !== void 0 ? value : null, { emitEvent: false });
        };
        InputSingleSelectComponent.prototype.onTouch = function () {
            this.touch.emit();
            if (!this.isDisabled && this.propagateTouch) {
                this.propagateTouch();
            }
        };
        InputSingleSelectComponent.prototype.setDisabledState = function (value) {
            this.isDisabled = value;
        };
        return InputSingleSelectComponent;
    }());
    exports.InputSingleSelectComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    providers: [
                        { provide: focus.SOF_FOCUS_COMPONENT, useExisting: InputSingleSelectComponent_1 }
                    ],
    ...
    exports.InputSingleSelectComponent.ctorParameters = function () { return [
    ...
    ], exports.InputSingleSelectComponent.prototype, "options$", void 0);
    exports.InputSingleSelectComponent = InputSingleSelectComponent_1 = __decorate([
        ngxReactivetoolkit.UntilDestroy()
    ], exports.InputSingleSelectComponent);

    var InputSingleSelectModule = /** @class */ (function () {
        function InputSingleSelectModule() {
        }
        return InputSingleSelectModule;
    }());
    InputSingleSelectModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    declarations: [exports.InputSingleSelectComponent],
                    exports: [exports.InputSingleSelectComponent]
                },] }
    ];
    ...
    exports.InputSingleSelectModule = InputSingleSelectModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=sofico-framework-ui-kit-components-input-single-select.umd.js.map
