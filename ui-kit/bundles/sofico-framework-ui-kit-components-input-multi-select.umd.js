(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@sofico-framework/ui-kit/components/form'), require('@sofico-framework/ui-kit/directives/focus'), require('ngx-reactivetoolkit'), require('rxjs/operators'), require('@angular/common'), require('@ngx-translate/core'), require('ng-zorro-antd/select')) :
    typeof define === 'function' && define.amd ? define('@sofico-framework/ui-kit/components/input-multi-select', ['exports', '@angular/core', '@angular/forms', '@sofico-framework/ui-kit/components/form', '@sofico-framework/ui-kit/directives/focus', 'ngx-reactivetoolkit', 'rxjs/operators', '@angular/common', '@ngx-translate/core', 'ng-zorro-antd/select'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['sofico-framework'] = global['sofico-framework'] || {}, global['sofico-framework']['ui-kit'] = global['sofico-framework']['ui-kit'] || {}, global['sofico-framework']['ui-kit'].components = global['sofico-framework']['ui-kit'].components || {}, global['sofico-framework']['ui-kit'].components['input-multi-select'] = {}), global.ng.core, global.ng.forms, global['sofico-framework']['ui-kit'].components.form, global['sofico-framework']['ui-kit'].directives.focus, global.ngxReactivetoolkit, global.rxjs.operators, global.ng.common, global.core$1, global.select));
}(this, (function (exports, core, forms, form, focus, ngxReactivetoolkit, operators, common, core$1, select) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.InputMultiSelectComponent = InputMultiSelectComponent_1 = /** @class */ (function () {
        function InputMultiSelectComponent(form, ngControl, changeDetectorRef) {
            var _this = this;
            this.form = form;
            ...
            this.internalFormControl = new forms.FormControl([]);
        ...
        InputMultiSelectComponent.prototype.sofFocus = function () {
            this.inputElement.nativeElement.getElementsByTagName('input')[0].focus();
            this.changeDetectorRef.detectChanges();
        };
        InputMultiSelectComponent.prototype.ngOnInit = function () {
            var _this = this;
            ...
            this.internalFormControl.valueChanges
                ...
                if (!_this.isDisabled) {
                    _this.changeValue.emit(_this.internalFormControl.value);
                    if (_this.propagateChange) {
                        _this.propagateChange(_this.internalFormControl.value);
                    }
                }
            });
        };
        InputMultiSelectComponent.prototype.ngOnChanges = function () { };
        InputMultiSelectComponent.prototype.ngOnDestroy = function () {
            var _a;
        ...
        InputMultiSelectComponent.prototype.registerOnChange = function (fn) {
            this.propagateChange = fn;
        };
        InputMultiSelectComponent.prototype.registerOnTouched = function (fn) {
            this.propagateTouch = fn;
        };
        InputMultiSelectComponent.prototype.writeValue = function (value) {
            this.internalFormControl.setValue(value !== null && value !== void 0 ? value : [], { emitEvent: false });
        };
        InputMultiSelectComponent.prototype.onTouch = function () {
            if (!this.isDisabled && this.propagateTouch) {
                this.propagateTouch();
            }
        };
        InputMultiSelectComponent.prototype.setDisabledState = function (value) {
            this.isDisabled = value;
        };
        return InputMultiSelectComponent;
    }());
    exports.InputMultiSelectComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    providers: [
                        { provide: focus.SOF_FOCUS_COMPONENT, useExisting: InputMultiSelectComponent_1 }
                    ],
    ...
    exports.InputMultiSelectComponent.ctorParameters = function () { return [
    ...
    exports.InputMultiSelectComponent.propDecorators = {
        tc: [{ type: core.Input }],
    ...
    ], exports.InputMultiSelectComponent.prototype, "options$", void 0);
    exports.InputMultiSelectComponent = InputMultiSelectComponent_1 = __decorate([
    ...
    InputMultiSelectModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    declarations: [exports.InputMultiSelectComponent],
                    exports: [exports.InputMultiSelectComponent]
                },] }
    ];
    ...
    exports.InputMultiSelectModule = InputMultiSelectModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=sofico-framework-ui-kit-components-input-multi-select.umd.js.map
