(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-reactivetoolkit'), require('@angular/common'), require('@sofico-framework/ui-kit/components/svg-icon')) :
    typeof define === 'function' && define.amd ? define('@sofico-framework/ui-kit/components/vertical-steps', ['exports', '@angular/core', 'ngx-reactivetoolkit', '@angular/common', '@sofico-framework/ui-kit/components/svg-icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['sofico-framework'] = global['sofico-framework'] || {}, global['sofico-framework']['ui-kit'] = global['sofico-framework']['ui-kit'] || {}, global['sofico-framework']['ui-kit'].components = global['sofico-framework']['ui-kit'].components || {}, global['sofico-framework']['ui-kit'].components['vertical-steps'] = {}), global.ng.core, global.ngxReactivetoolkit, global.ng.common, global['sofico-framework']['ui-kit'].components['svg-icon']));
}(this, (function (exports, core, ngxReactivetoolkit, common, svgIcon) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var VerticalStepsComponent = /** @class */ (function () {
        function VerticalStepsComponent() {
            /**
        ...
        Object.defineProperty(VerticalStepsComponent.prototype, "steps", {
            set: function (items) {
                var _this = this;
                this.activeIndex = items.indexOf(__spread(items).reverse().find(function (x) { return x.active; }));
                this.internalSteps = items.map(function (step, index) { return (Object.assign(Object.assign({}, step), { active: index === _this.activeIndex })); });
            },
            enumerable: false,
            configurable: true
        });
        VerticalStepsComponent.prototype.ngOnChanges = function () { };
    ...
    VerticalStepsComponent.propDecorators = {
        sizeBullets: [{ type: core.Input }],
        reverse: [{ type: core.Input }],
        steps: [{ type: core.Input }],
        headerTemplateRef: [{ type: core.ContentChild, args: ['step', { static: false },] }]
    };
    __decorate([
        ngxReactivetoolkit.Changes('steps')
    ], VerticalStepsComponent.prototype, "steps$", void 0);

    var VerticalStepsModule = /** @class */ (function () {
        function VerticalStepsModule() {
        }
        return VerticalStepsModule;
    }());
    ...
    exports.VerticalStepsComponent = VerticalStepsComponent;
    exports.VerticalStepsModule = VerticalStepsModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=sofico-framework-ui-kit-components-vertical-steps.umd.js.map
