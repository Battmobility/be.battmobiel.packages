...
HttpStatusService.ɵfac = function HttpStatusService_Factory(t) { return new (t || HttpStatusService)(); };
...
WindowRefService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: WindowRefService, factory: WindowRefService.ɵfac });
...
RoutingAllowedGuard.ɵfac = function RoutingAllowedGuard_Factory(t) { return new (t || RoutingAllowedGuard)(); };
RoutingAllowedGuard.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RoutingAllowedGuard, factory: RoutingAllowedGuard.ɵfac });
...
UtilGuardsModule.ɵfac = function UtilGuardsModule_Factory(t) { return new (t || UtilGuardsModule)(ɵngcc0.ɵɵinject(UtilGuardsModule, 12)); };
UtilGuardsModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: UtilGuardsModule });
UtilGuardsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [RoutingAllowedGuard] });
...
CacheOverrideInterceptor.ɵfac = function CacheOverrideInterceptor_Factory(t) { return new (t || CacheOverrideInterceptor)(ɵngcc0.ɵɵinject(WindowRefService), ɵngcc0.ɵɵinject(CacheOverrideConfigAbstract)); };
CacheOverrideInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CacheOverrideInterceptor, factory: CacheOverrideInterceptor.ɵfac });
...
CacheOverrideModule.ɵfac = function CacheOverrideModule_Factory(t) { return new (t || CacheOverrideModule)(ɵngcc0.ɵɵinject(CacheOverrideModule, 12), ɵngcc0.ɵɵinject(WindowRefService, 8), ɵngcc0.ɵɵinject(CacheOverrideConfigAbstract, 8)); };
CacheOverrideModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: CacheOverrideModule });
CacheOverrideModule.ɵinj = ɵngcc0.ɵɵdefineInjector({});
...
HttpStatusInterceptor.ɵfac = function HttpStatusInterceptor_Factory(t) { return new (t || HttpStatusInterceptor)(ɵngcc0.ɵɵinject(HttpStatusService)); };
...
ObjectService.ɵfac = function ObjectService_Factory(t) { return new (t || ObjectService)(); };
ObjectService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ObjectService, factory: ObjectService.ɵfac });
...
PageTitleService.ɵfac = function PageTitleService_Factory(t) { return new (t || PageTitleService)(ɵngcc0.ɵɵinject(ɵngcc1.Title), ɵngcc0.ɵɵinject(ɵngcc2.TranslateService), ɵngcc0.ɵɵinject(ObjectService), ɵngcc0.ɵɵinject(PAGE_TITLE_TOKEN, 8)); };
PageTitleService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PageTitleService, factory: function (t) { return PageTitleService.ɵfac(t); } });
...
PageTitleModule.ɵfac = function PageTitleModule_Factory(t) { return new (t || PageTitleModule)(ɵngcc0.ɵɵinject(PageTitleModule, 12)); };
PageTitleModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PageTitleModule });
PageTitleModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [PageTitleService], imports: [[CommonModule, TranslateModule]] });
...
BlobToImgSrcPipe.ɵfac = function BlobToImgSrcPipe_Factory(t) { return new (t || BlobToImgSrcPipe)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DomSanitizer), ɵngcc0.ɵɵdirectiveInject(WindowRefService)); };
BlobToImgSrcPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofBlobToImgSrc", type: BlobToImgSrcPipe, pure: true });
...
ConcatPipe.ɵfac = function ConcatPipe_Factory(t) { return new (t || ConcatPipe)(); };
ConcatPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofConcat", type: ConcatPipe, pure: true });
...
DeepFetchPropertyPipe.ɵfac = function DeepFetchPropertyPipe_Factory(t) { return new (t || DeepFetchPropertyPipe)(); };
DeepFetchPropertyPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofDeepFetchProperty", type: DeepFetchPropertyPipe, pure: true });
...
ExecutePipe.ɵfac = function ExecutePipe_Factory(t) { return new (t || ExecutePipe)(); };
ExecutePipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofExecute", type: ExecutePipe, pure: true });
...
FindPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofFind", type: FindPipe, pure: true });
...
IncludesPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofIncludes", type: IncludesPipe, pure: true });
...
DocumentRefService.ɵfac = function DocumentRefService_Factory(t) { return new (t || DocumentRefService)(); };
DocumentRefService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DocumentRefService, factory: DocumentRefService.ɵfac });
...
InfiniteScrollPipe.ɵfac = function InfiniteScrollPipe_Factory(t) { return new (t || InfiniteScrollPipe)(ɵngcc0.ɵɵdirectiveInject(WindowRefService), ɵngcc0.ɵɵdirectiveInject(DocumentRefService), ɵngcc0.ɵɵinjectPipeChangeDetectorRef()); };
InfiniteScrollPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofInfiniteScroll", type: InfiniteScrollPipe, pure: false });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(HttpStatusService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RoutingAllowedGuard, [{
        type: Injectable
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UtilGuardsModule, [{
        type: NgModule,
        args: [{
                providers: [RoutingAllowedGuard]
            }]
    }], function () { return [{ type: UtilGuardsModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }]; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CacheOverrideInterceptor, [{
        type: Injectable
    }], function () { return [{ type: WindowRefService }, { type: CacheOverrideConfigAbstract }]; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CacheOverrideModule, [{
        type: NgModule
    }], function () { return [{ type: CacheOverrideModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }, { type: WindowRefService, decorators: [{
                type: Optional
            }] }, { type: CacheOverrideConfigAbstract, decorators: [{
                type: Optional
            }] }]; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(HttpStatusInterceptor, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: HttpStatusService }]; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ObjectService, [{
        type: Injectable
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PageTitleService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.Title }, { type: ɵngcc2.TranslateService }, { type: ObjectService }, { type: undefined, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [PAGE_TITLE_TOKEN]
            }] }]; }, null); })();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PageTitleModule, { imports: function () { return [CommonModule, TranslateModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PageTitleModule, [{
        type: NgModule,
        args: [{
                imports: [CommonModule, TranslateModule],
                providers: [PageTitleService]
            }]
    }], function () { return [{ type: PageTitleModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }]; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BlobToImgSrcPipe, [{
        type: Pipe,
        args: [{ name: 'sofBlobToImgSrc' }]
    }], function () { return [{ type: ɵngcc1.DomSanitizer }, { type: WindowRefService }]; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ConcatPipe, [{
        type: Pipe,
        args: [{ name: 'sofConcat' }]
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DeepFetchPropertyPipe, [{
        type: Pipe,
        args: [{ name: 'sofDeepFetchProperty' }]
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ExecutePipe, [{
        type: Pipe,
        args: [{ name: 'sofExecute' }]
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FindPipe, [{
        type: Pipe,
        args: [{ name: 'sofFind' }]
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(IncludesPipe, [{
        type: Pipe,
        args: [{ name: 'sofIncludes' }]
    }], function () { return []; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DocumentRefService, [{
        type: Injectable
    }], null, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(InfiniteScrollPipe, [{
        type: Pipe,
        args: [{ name: 'sofInfiniteScroll', pure: false }]
    }], function () { return [{ type: WindowRefService }, { type: DocumentRefService }, { type: ɵngcc0.ChangeDetectorRef }]; }, null); })();
...
IsNullOrUndefinedPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofIsNullOrUndefined", type: IsNullOrUndefinedPipe, pure: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(IsNullOrUndefinedPipe, [{
        type: Pipe,
        args: [{ name: 'sofIsNullOrUndefined' }]
    }], null, null); })();
...
IsNumberPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofIsNumber", type: IsNumberPipe, pure: true });
...
KeysPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofKeys", type: KeysPipe, pure: true });
...
LocalNumberPipe.ɵfac = function LocalNumberPipe_Factory(t) { return new (t || LocalNumberPipe)(); };
LocalNumberPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofLocalNumber", type: LocalNumberPipe, pure: true });
LocalNumberPipe.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(LocalNumberPipe, [{
        type: Pipe,
        args: [{ name: 'sofLocalNumber' }]
    }], function () { return []; }, null); })();
...
MaxPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofMax", type: MaxPipe, pure: true });
...
MaxStringLengthPipe.ɵfac = function MaxStringLengthPipe_Factory(t) { return new (t || MaxStringLengthPipe)(); };
MaxStringLengthPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofMaxStringLength", type: MaxStringLengthPipe, pure: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MaxStringLengthPipe, [{
        type: Pipe,
        args: [{
...
ReplaceAllPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofReplaceAll", type: ReplaceAllPipe, pure: true });
ReplaceAllPipe.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ReplaceAllPipe, [{
        type: Pipe,
        args: [{ name: 'sofReplaceAll' }]
    }], function () { return []; }, null); })();
...
SafeUrlPipe.ɵfac = function SafeUrlPipe_Factory(t) { return new (t || SafeUrlPipe)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DomSanitizer)); };
SafeUrlPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofSafeUrl", type: SafeUrlPipe, pure: true });
SafeUrlPipe.ctorParameters = () => [
    { type: DomSanitizer }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SafeUrlPipe, [{
        type: Pipe,
        args: [{ name: 'sofSafeUrl' }]
...
SortPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofSort", type: SortPipe, pure: true });
...
CurrencySymbolPipe.ɵfac = function CurrencySymbolPipe_Factory(t) { return new (t || CurrencySymbolPipe)(ɵngcc0.ɵɵdirectiveInject(LOCALE_ID)); };
CurrencySymbolPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "sofCurrencySymbol", type: CurrencySymbolPipe, pure: true });
CurrencySymbolPipe.ctorParameters = () => [
    { type: String, decorators: [{ type: Inject, args: [LOCALE_ID,] }] }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CurrencySymbolPipe, [{
        type: Pipe,
        args: [{
...
UtilsPipesModule.ɵfac = function UtilsPipesModule_Factory(t) { return new (t || UtilsPipesModule)(); };
UtilsPipesModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: UtilsPipesModule });
UtilsPipesModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(UtilsPipesModule, { declarations: function () { return [SortPipe, SafeUrlPipe, ReplaceAllPipe, MaxPipe, LocalNumberPipe, KeysPipe, IsNullOrUndefinedPipe, IsArrayPipe, IsNumberPipe, InfiniteScrollPipe, IncludesPipe, FindPipe, ExecutePipe, DeepFetchPropertyPipe, ConcatPipe, BlobToImgSrcPipe, MaxStringLengthPipe, CurrencySymbolPipe]; }, imports: function () { return [CommonModule]; }, exports: function () { return [SortPipe, SafeUrlPipe, ReplaceAllPipe, MaxPipe, LocalNumberPipe, KeysPipe, IsNullOrUndefinedPipe, IsArrayPipe, IsNumberPipe, InfiniteScrollPipe, IncludesPipe, FindPipe, ExecutePipe, DeepFetchPropertyPipe, ConcatPipe, BlobToImgSrcPipe, MaxStringLengthPipe, CurrencySymbolPipe]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UtilsPipesModule, [{
        type: NgModule,
        args: [{
...
DocumentDownloadService.ɵfac = function DocumentDownloadService_Factory(t) { return new (t || DocumentDownloadService)(ɵngcc0.ɵɵinject(DocumentRefService), ɵngcc0.ɵɵinject(WindowRefService)); };
DocumentDownloadService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DocumentDownloadService, factory: DocumentDownloadService.ɵfac });
DocumentDownloadService.ctorParameters = () => [
    { type: DocumentRefService },
    { type: WindowRefService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DocumentDownloadService, [{
        type: Injectable
    }], function () { return [{ type: DocumentRefService }, { type: WindowRefService }]; }, null); })();
...
FileSelectionService.ɵfac = function FileSelectionService_Factory(t) { return new (t || FileSelectionService)(ɵngcc0.ɵɵinject(DocumentRefService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FileSelectionService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: DocumentRefService }]; }, null); })();
...
FormGroupService.ɵfac = function FormGroupService_Factory(t) { return new (t || FormGroupService)(ɵngcc0.ɵɵinject(ɵngcc3.FormBuilder)); };
FormGroupService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FormGroupService, factory: FormGroupService.ɵfac });
FormGroupService.ctorParameters = () => [
    { type: FormBuilder }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FormGroupService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc3.FormBuilder }]; }, null); })();
...
RouterToolsService.ɵfac = function RouterToolsService_Factory(t) { return new (t || RouterToolsService)(ɵngcc0.ɵɵinject(ɵngcc4.Router), ɵngcc0.ɵɵinject(ɵngcc5.ViewportScroller)); };
RouterToolsService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RouterToolsService, factory: RouterToolsService.ɵfac });
RouterToolsService.ctorParameters = () => [
    { type: Router },
    { type: ViewportScroller }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RouterToolsService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc4.Router }, { type: ɵngcc5.ViewportScroller }]; }, null); })();
...
ScrollService.ɵfac = function ScrollService_Factory(t) { return new (t || ScrollService)(ɵngcc0.ɵɵinject(WindowRefService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ScrollService, [{
        type: Injectable
    }], function () { return [{ type: WindowRefService }]; }, null); })();
...
UtilServicesModule.ɵfac = function UtilServicesModule_Factory(t) { return new (t || UtilServicesModule)(ɵngcc0.ɵɵinject(UtilServicesModule, 12), ɵngcc0.ɵɵinject(ɵngcc4.Router, 8), ɵngcc0.ɵɵinject(ɵngcc3.FormBuilder, 8), ɵngcc0.ɵɵinject(ɵngcc2.TranslateService, 8)); };
UtilServicesModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: UtilServicesModule });
UtilServicesModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [
        WindowRefService,
        DocumentRefService,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UtilServicesModule, [{
        type: NgModule,
        args: [{
                providers: [
                    WindowRefService,
    ...
    }], function () { return [{ type: UtilServicesModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }, { type: ɵngcc4.Router, decorators: [{
                type: Optional
            }] }, { type: ɵngcc3.FormBuilder, decorators: [{
                type: Optional
            }] }, { type: ɵngcc2.TranslateService, decorators: [{
                type: Optional
            }] }]; }, null); })();
...
DateMapper.ɵfac = function DateMapper_Factory(t) { return new (t || DateMapper)(); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DateMapper, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], null, null); })();
